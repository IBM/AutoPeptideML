                ...
                if mol is None:
                    ...
                    if g.num_nodes('a') == 0:
                        ...
                        if self.transform:
                            ...
                            # graphs.append(self.transform(g))
...
def make_loaders(ddp, dataset, world_size, global_rank, batch_size, num_workers, transform):
...
if __name__=='__main__':
    ...
    random_split(path,'/mnt/data/xiuyuting/test/')
